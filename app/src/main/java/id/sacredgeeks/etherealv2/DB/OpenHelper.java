...
public class OpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_CREATE = "CREATE TABLE jadwal ("+J_KOLOM_ID_JADWAL+" INTEGER PRIMARY KEY AUTOINCREMENT,"
                                                +J_KOLOM_NAMA+" TEXT, "+J_KOLOM_KETERANGAN+" TEXT, "
                                                +J_KOLOM_DAY+"DATE,"+J_KOLOM_ALARM+"TIME,"+J_KOLOM_PATHIMG+" TEXT)";

    public static final String TABLE_CREATE2 = "CREATE TABLE tugas ("+T_KOLOM_ID_TUGAS+" INTEGER PRIMARY KEY AUTOINCREMENT,"
                                                +T_KOLOM_NAMA+" TEXT, "+T_KOLOM_KETERANGAN+" TEXT,"+T_KOLOM_DEADLINE+" DATE,"
                                                +T_KOLOM_ALARM+"ALARM TIME,"+T_KOLOM_PATHIMG+" TEXT)";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        sqLiteDatabase.execSQL("DROP TABLE IF EXIST jadwal,tugas");
    }
}
